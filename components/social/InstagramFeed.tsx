    ...
    try {
      if (accessToken) {
        ...
        const fallbackPosts: InstagramPost[] = [
          {
            id: 'dome-living-room',
            imageUrl: '/images/dome/dome-interior-living-dining-kitchenette.avif',
            postUrl: `https://instagram.com/${username}`,
            alt: 'Inside the dome: dining table, leather sofa, kitchenette and spiral staircase to the loft',
          },
          {
          ...
          {
            id: 'dome-deck',
            imageUrl: '/images/dome/deck-table-wooden-deck-pine-forest-view.webp',
            postUrl: `https://instagram.com/${username}`,
            alt: 'Spacious wooden deck looking out over the East Texas pine forest',
          },
          {
            id: 'private-pond',
            imageUrl: '/images/dome/private-pond-aerial-pine-forest.avif',
            postUrl: `https://instagram.com/${username}`,
    ...
    >
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          <BackgroundGradient
            className="inline-block p-[3px] mb-4 rounded-xl"
            gradientColor="from-brand-400 via-gold-300 to-brand-400"
            containerClassName="bg-white px-6 py-3"
          >
            <h2 
              id="instagram-heading" 
              className="text-3xl font-bold flex items-center justify-center text-brand-900"
            >
              <svg 
